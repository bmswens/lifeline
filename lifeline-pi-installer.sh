...
curl https://aw.githubusercontent.com/bmswens/lifeline/blob/master/lifeline-pi/lifeline.sh > /opt/lifeline-pi/lifeline.sh
curl https://aw.githubusercontent.com/bmswens/lifeline/blob/master/lifeline-pi/lifeline.yml > /opt/lifeline-pi/lifeline.yml
